...
* Date: Wed Feb 22 18:19:58 2017
* Arguments: "-B" "macro_default" "-W" "dotnet:dlltest,Class1,4.0,private" "-T"
* "link:lib" "-d" "C:\Program Files\MATLAB\R2013a\bin\dlltest\src" "-w"
* "enable:specified_file_mismatch" "-w" "enable:repeated_file" "-w"
* "enable:switch_ignored" "-w" "enable:missing_lib_sentinel" "-w" "enable:demo_license"
* "-v" "class{Class1:C:\Program Files\MATLAB\R2013a\bin\myfunc.m}" 
*/
using System;
...
namespace dlltestNative
{
  ...
  /// <newpara></newpara>
  /// C:\Program Files\MATLAB\R2013a\bin\myfunc.m
  /// <newpara></newpara>
  /// deployprint.m
  /// <newpara></newpara>
  /// printdlg.m
